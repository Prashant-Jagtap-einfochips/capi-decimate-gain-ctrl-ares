...
/*===========================================================================
   FUNCTION : control_tx_process_get_properties
   ...
   for (i = 0; i < proplist_ptr->props_num; i++)
   {
      ...
      switch (prop_array[i].id)
      {
         ...
         case CAPI_OUTPUT_MEDIA_FORMAT_V2:
         {
            ...
            {
               control_tx_media_fmt_t *data_ptr = (control_tx_media_fmt_t *)payload_ptr->data_ptr;
         ...
         case CAPI_INTERFACE_EXTENSIONS:
	 {
	    ...
	    {
		AR_MSG(DBG_ERROR_PRIO,"capi_us_detect_process_get_properties:CAPI_INTERFACE_EXTENSIONS Bad param size %lu",payload_max_data_len);
		CAPI_SET_ERROR(capi_result, CAPI_ENEEDMORE);
	    }
	    break;
	}
...
/*===========================================================================
   FUNCTION : control_tx_process_set_properties
...
capi_err_t control_tx_process_set_properties(control_tx_t *me_ptr, capi_proplist_t *proplist_ptr)
{
   ...
   for (i = 0; i < proplist_ptr->props_num; i++)
   {
      ...
      switch (prop_array[i].id)
      {
         ...
         {
            if (payload_ptr->actual_data_len >= sizeof(control_tx_media_fmt_t))
            {
               control_tx_media_fmt_t *media_fmt_ptr = (control_tx_media_fmt_t *)(payload_ptr->data_ptr);
               ...
               control_tx_raise_threshold_event(&me_ptr->cb_info, me_ptr->threshold_in_bytes, TRUE, 0);
               /* Raise events*/
...
/*===========================================================================
FUNCTION : control_tx_release_memory
...
/*===========================================================================
   FUNCTION : control_tx_update_event_states
   DESCRIPTION: Function to update the event states for software decimation
===========================================================================*/
static void control_tx_update_event_states(control_tx_t *me_ptr)
{
...
/*===========================================================================
   FUNCTION : control_tx_raise_event
...
void control_tx_raise_event(control_tx_t *me_ptr)
{
   ...
   control_tx_update_event_states(me_ptr);
   control_tx_raise_process_event(me_ptr);
   control_tx_raise_delay_event(me_ptr);
}

/*===========================================================================
   FUNCTION : control_tx_output_media_format_event
...
/*===========================================================================
   FUNCTION : control_tx_raise_process_event
...
/*===========================================================================
   FUNCTION : control_tx_raise_delay_event
   DESCRIPTION: Function to send process check using the callback function
===========================================================================*/
...
/*===========================================================================
   FUNCTION : control_tx_raise_threshold_event
   DESCRIPTION: Function to send process check using the callback function
===========================================================================*/
